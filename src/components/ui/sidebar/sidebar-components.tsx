...
import { sidebarMenuButtonVariants } from "./types"
import { useSidebar } from "./context"

export const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentPropsWithRef<"div">>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      data-sidebar="header"
...
export const SidebarMenuButton = React.forwardRef<HTMLButtonElement, React.ComponentProps<"button"> & {
  ...
  return (
    <Comp
      ref={ref}
      className={cn(sidebarMenuButtonVariants({ variant: "default", size: "default" }), className)}
